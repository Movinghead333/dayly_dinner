...
const String kDaylyDinner = 'Dayly Dinner';

// localization
const String kRecipes = 'Rezepte';
const String kRecipeName = 'Rezeptname';
const String kAddRecipe = 'Rezept hinzufügen';
const String kAdd = 'Hinzufügen';
const String kCancel = 'Abbrechen';
const String kDeleteRecipe = 'Rezept löschen';
